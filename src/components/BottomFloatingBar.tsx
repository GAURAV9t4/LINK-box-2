...
export const BottomFloatingBar: React.FC<BottomFloatingBarProps> = ({
  ...
  return (
    <>
      ...
      <div className="fixed bottom-20 sm:bottom-20 right-4 sm:right-8 z-40 isolate transform-gpu">
        <button
          type="button"
      ...
      <div className="fixed bottom-3 left-1/2 -translate-x-1/2 z-40 max-w-2xl w-[94%] sm:w-auto isolate transform-gpu">
        <div className="bg-[#121528] sm:bg-[#121528]/95 sm:backdrop-blur-md border border-[#2b315c] rounded-2xl px-3 py-2 shadow-2xl flex items-center justify-between sm:justify-center gap-2 sm:gap-4 text-xs text-zinc-300">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <button
              type="button"
              onClick={onScrollToTop}
              className="px-2 py-1 rounded-lg hover:bg-white/5 hover:text-white transition-colors cursor-pointer"
            >
              Home
            </button>
            ...
            <button
              ...
              className="px-2 py-1 rounded-lg hover:bg-white/5 hover:text-white transition-colors hidden sm:inline cursor-pointer"
            >
              DMCA
            </button>
            ...
            <button
              ...
              className="px-2 py-1 rounded-lg bg-emerald-950/40 hover:bg-emerald-900/60 text-emerald-300 hover:text-white border border-emerald-500/30 transition-colors flex items-center gap-1 font-semibold cursor-pointer"
            >
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse"></span>
            ...
            {onExportData && (
              <button
                ...
                className="px-2 py-1 rounded-lg bg-indigo-950/50 hover:bg-indigo-900/80 text-indigo-300 hover:text-white border border-indigo-500/40 transition-colors flex items-center gap-1 font-semibold cursor-pointer"
              >
            ...
            {onExportCSV && (
              <button
                ...
                className="px-2 py-1 rounded-lg bg-emerald-950/60 hover:bg-emerald-900/80 text-emerald-300 hover:text-white border border-emerald-500/40 transition-colors flex items-center gap-1 font-semibold cursor-pointer"
              >
            ...
            <button
              ...
              className="px-2 py-1 rounded-lg bg-purple-900/40 hover:bg-purple-900/70 text-purple-300 hover:text-white border border-purple-500/40 transition-colors flex items-center gap-1 font-semibold cursor-pointer"
            >
            ...
            {onOpenSupportModal && (
              <button
                ...
                className="px-2 py-1 rounded-lg bg-pink-950/60 hover:bg-pink-900/80 text-pink-300 hover:text-white border border-pink-500/40 transition-colors flex items-center gap-1 font-semibold cursor-pointer shadow-xs"
              >
